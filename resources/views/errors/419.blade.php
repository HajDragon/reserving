...
<head>
    ...
    <title>419 — {{ __("Sessie verlopen") }} — {{ config('app.name') }}</title>
...
<body class="flex min-h-screen items-center justify-center bg-white antialiased dark:bg-zinc-800">
    <div class="mx-auto max-w-md px-6 text-center">
        <div class="mb-6 text-7xl font-bold text-zinc-300 dark:text-zinc-600">419</div>
        <h1 class="mb-4 text-2xl font-semibold text-zinc-900 dark:text-white">{{ __("Sessie verlopen") }}</h1>
