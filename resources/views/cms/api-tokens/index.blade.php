            ...
            <div class="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <form method="POST" action="{{ route('cms.api-tokens.store') }}" class="mt-4 space-y-4">
                    ...
                    <label class="block space-y-1 text-sm text-zinc-600 dark:text-zinc-300">
                        <span>{{ __('User') }}</span>
                        <select name="user_id" class="p-2 h-10 w-full rounded-lg border-zinc-300 bg-gray-200 text-zinc-900 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100">
                    ...
                    <label class="block space-y-1 text-sm text-zinc-600 dark:text-zinc-300">
                        ...
                        <input
                            ...
                            class="p-2 h-10 w-full rounded-lg border-zinc-300 bg-gray-200 text-zinc-900 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100"
                        >
                        @error('name')
                            <span class="text-xs text-red-600 dark:text-red-400">{{ $message }}</span>
                        @enderror
                ...
                <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                    ...
                    <form method="GET" action="{{ route('cms.api-tokens.index') }}" class="grid gap-3 sm:min-w-[24rem]">
                        ...
                        <label class="block space-y-1 text-sm text-zinc-600 dark:text-zinc-300">
                            ...
                            <select name="ability" class="p-2 h-10 w-full rounded-lg border-zinc-300 bg-gray-200 text-zinc-900 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-100">
